  ...
  return `
    <div class="search-bar">
      <div class="search-wrap">
        ...
        <input class="search-input" type="text" placeholder="Search items, e.g. sword, boots…" value="${escHtml(searchQuery)}" id="search-input" autocomplete="off" />
      </div>
    </div>
    ...
    <div class="manage-area">
      <div>
        ...
        <div class="add-form">
          ...
          <div style="font-size:12px; color: var(--text3); font-style: italic; line-height: 1.5;">Tip: Right-click any image in OBR's asset dock → "Copy image address" to get its URL.</div>
        </div>
      </div>
      <div>
